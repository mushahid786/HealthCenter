			...
			<div class="row">
				<div class="col-md-12"  style="padding:20px;">
					<div class="panel panel-default" style="outline: 1px dashed #26A65B; color:" >
                        ...
                        <h4 style="color:white;"><i class="fa fa-" style="margin-right: 5px;">&nbsp;&nbsp;&nbsp;Edit Your Details </i></h4></div>
							<div class="panel-body">
							<form method="POST" action ="patienteditdetails.php">
									<br>
							<div class="row">
							...
							<div class="row">	
								  <div class="col-md-1"></div>  
									<div class="col-md-4" style="padding:5px;font-size:25px;" ><i class="fa fa-">District:</i></div>
									
									<div class="col-md-6" style="padding:5px;">	  
										<input type="text" name="district" placeholder="District" pattern="[A-za-z]+" style ="Padding:6px;;width:100%;" required/></div>
							</div>
							<br>			
							<div class="row">
								 <div class="col-md-1"></div> 
									<div class="col-md-4" style="padding:5px;font-size:25px;" ><i class="fa fa-">State:</i></div>
									
									<div class="col-md-6" style="padding:5px;">	  
										<select name="state" value="state" required="required" style ="Padding:6px;;width:100%;">
						...
						<br>
							...
							<div class="row">
								...
								<div class="col-md-4" style="padding:5px;font-size:25px;" ><i class="fa fa-">Contact:</i></div>
									...
									<div class="col-md-6" style="padding:5px;">	  
										<input type="text"  name="mobile" maxlength="10"  style ="Padding:6px;;width:100%;" value="<?php echo $mobile;?>"  placeholder="Mobile Number"  pattern="\d{10}" required/>
									</div>	 
							</div>		
							<br>		
							<div class="row">
								<div class="col-md-1"></div>  
									<div class="col-md-4" style="padding:5px;font-size:25px;" ><i class="fa fa-">PIN Code:</i></div>
									
									<div class="col-md-6" style="padding:5px;">	  
										<div id ="appoint" > <input type="text"  name="pincode" maxlength="6"  style ="Padding:6px;;width:100%;" pattern="\d{6}" required/></div>
									</div>
							...
							<footer align="center" style="background-color:#185953;">
								<div class="row" >
										<div class="col-md-12">
										<input type="submit" name="setprofile"  style="color:green;width:150px;font-size:20px;margin-left:0px;;border-radius:10px;" value="Update">
	...
	if(isset($_POST['setprofile']))
{
	...
	//$pass1=$_POST['pass1'];
		...
		$query="UPDATE `patient_profile` SET `name`='$name',`age`='$age',`gender`='$gender',`blood_group`='$bloodgroup',`address`='$address',`district`='$district',`state`='$state',`mobile`='$mobile',`pincode`='$pincode' where gmail='$emailid'";
		$run=mysqli_query($conn, $query);
	$emailid ;
	if($run)
	{
		echo "<script>window.alert('Your Profile has been Update Successfully Thank You ..!')</script>";
